...
1. Create canonical stream directory: `vault/stream-videos/YYYY-MM/YYYY-MM-DD_day-N/{stream.stream_key}/`
   The day number N is assigned sequentially — the CLI scans existing day folders and assigns the next number for new dates.
