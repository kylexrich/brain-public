...
| `criteria_path`      | Absolute path to `system/ai-config/claude-config/skills/job-video-processing-pipeline/2-process-video/stages/08-clip-suggestions/criteria.md` |
