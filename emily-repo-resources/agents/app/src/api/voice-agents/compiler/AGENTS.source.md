...
- `app/src/api/voice-agents/compiler/domain/`: voice-agent-specific implementations wired into the engine.
  ...
  - `app/src/api/voice-agents/compiler/domain/outbound-automation-workflows/`: outbound automation workflow compile context, domain pack, pipeline, base skeleton, outbound-only composition rules, and outbound automation workflow module registries.
...
# `app/src/api/voice-agents/compiler/` Guidance & Rules (DO NOT EDIT. EDIT `app/src/api/voice-agents/compiler/.ai/guidance/` ONLY)
