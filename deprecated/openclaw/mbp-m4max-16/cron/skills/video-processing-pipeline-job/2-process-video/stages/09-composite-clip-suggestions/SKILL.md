...
| `criteria_path`      | Absolute path to `deprecated/openclaw/mbp-m4max-16/cron/skills/video-processing-pipeline-job/2-process-video/stages/09-composite-clip-suggestions/criteria.md` |
| `privacy_rules_path` | Absolute path to `deprecated/openclaw/mbp-m4max-16/cron/skills/video-processing-pipeline-job/2-process-video/shared/privacy-rules.md`                          |

Each worker must:

1. Read the chunk file at `chunk_file_path`.
2. Apply all composite criteria from
   `deprecated/openclaw/mbp-m4max-16/cron/skills/video-processing-pipeline-job/2-process-video/stages/09-composite-clip-suggestions/criteria.md`.
3. Apply all exclusions from `deprecated/openclaw/mbp-m4max-16/cron/skills/video-processing-pipeline-job/2-process-video/shared/privacy-rules.md`.
4. Return JSON conforming to
   `deprecated/openclaw/mbp-m4max-16/cron/skills/video-processing-pipeline-job/2-process-video/stages/09-composite-clip-suggestions/composite_clip_suggestions.worker-result.schema.jsonc`.
