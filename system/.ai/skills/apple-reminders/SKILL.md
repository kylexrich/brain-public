...
- Scheduling timed notifications → use the `schedule` skill
- Calendar events or appointments → use Apple Calendar or Google Calendar MCP
- Project/work task management → use GitHub Issues or a task queue
- User says "remind me" but wants a timed scheduled notification → use the `schedule` skill
...
- Scheduled notification → use the `schedule` skill
