---
name: emly-prod-log-check-afternoon
description: Afternoon EMLY prod log-health check → posts digest to Slack #alarms
---

Automated EMLY production log-health check (afternoon run).
