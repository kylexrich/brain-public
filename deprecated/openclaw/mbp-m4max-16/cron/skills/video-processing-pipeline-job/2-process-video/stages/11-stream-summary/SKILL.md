...
youtube_metadata:
  ...
  template: deprecated/openclaw/mbp-m4max-16/cron/skills/video-processing-pipeline-job/2-process-video/shared/youtube-description-template.md
```
...
1. Spawn a single worker that reads all chunk files in `chunks_dir` chronologically.
2. Worker generates a summary per `summary-rules.md`.
...
2. Update the summary section of `youtube_metadata_file` per
   `deprecated/openclaw/mbp-m4max-16/cron/skills/video-processing-pipeline-job/2-process-video/shared/youtube-description-template.md`.
