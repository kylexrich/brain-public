---
name: emly-prod-log-check-morning
description: Morning EMLY prod log-health check → posts digest to Slack #alarms
---

Automated EMLY production log-health check (morning run).
