...
| `cut_rubric_path`         | Absolute path to `system/ai-config/claude-config/skills/job-video-processing-pipeline/2-process-video/stages/06-vod-cut-recommendations/cut-rubric.md` |
